...
public class OrderService {
	...
	public int buySomething(int userId, long money){
		...
		System.out.println("exec deductRequest start...");
		transaction.execute(deductRequest);
		System.out.println("exec deductRequest end...");
		...
		System.out.println("exec UpdateOrderStatus start...");
	...
	public void cancelOrder(int orderId) {
		System.out.println("exec cancelOrder start: " + orderId);
		/**
		 ...
		 */
		final String INSERT_SQL = "DELETE FROM public.order WHERE order_id= ?";
		KeyHolder keyHolder = new GeneratedKeyHolder();
		jdbcTemplate.update(
		    new PreparedStatementCreator() {
		    	@Override
		    ...
		    keyHolder);
		System.out.println("exec cancelOrder end: " + orderId);
	}
	
	public void confirmOrder(int orderId) {
		System.out.println("exec confirmOrder start: " + orderId);
		/**
		 ...
		 */
		System.out.println("exec confirmOrder end: " + orderId);
	}
